                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src={product.image} /> <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => { buyNow(slug, 1, 499, product.title, product.size, product.color) }} className="flex ml-8 text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded">Buy Now</button>
                            <button onClick={() => { addToCart(slug, 1, 499, product.title, product.size, product.color) }} className="flex ml-2 text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded">Add to cart</button>
                        ...
                        <div className="pin mt-6 flex space-x-2 text-sm">
                            ...
                            <button onClick={checkServiceAbitlity} className='flex ml-14 text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded'>Check</button>
                        </div>
