                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-8 text-sm text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded">Buy Now</button><button onClick={() => { addToCart(slug, 1, 499, 'Wear the code(XL, Red)', 'XL', 'Red') }} className="flex ml-4 text-sm text-white bg-orange-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-orange-600 rounded">Add to Cart</button>
                            ...
                            <div className="pin flex mt-6 text-sm space-x-2">
                                ...
                                <button onClick={checkServiceability} className='text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded'>Check</button>
                            </div>
