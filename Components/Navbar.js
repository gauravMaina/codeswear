...
const Navbar = () => {
    ...
    return (
        <div className="shadow-md flex flex-col md:flex-row md:justify-start justify-center items-center  py-3">
            ...
            <div ref={ref} onClick={toggleCart} className="w-72 h-full sideCart absolute bg-orange-100 top-0 right-0 py-10 px-8 transform transition-transform translate-x-full">
                <h2 className="font-bold text-xl text-center">Shopping Cart</h2>
                <span className="absolute top-3 right-2 cursor-pointer text-2xl text-orange-500"><AiFillCloseCircle /></span>
                    ...
                    <li>
                        <div className="item flex my-5">
                            ...
                            <div className="flex items-center justify-center w-1/3 font-semibold">
                                <AiFillMinusCircle className="cursor-pointer text-orange-500" /> <span className="mx-2">1</span> <AiFillPlusCircle className="cursor-pointer text-orange-500" /></div>
                        </div>
                    </li>
